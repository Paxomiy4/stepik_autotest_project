...
def test_guest_can_add_product_to_basket(browser, link):
    ...
    page.check_current_book_add_to_basket()
    page.check_basket_price_equal_book_price()
...
class TestUserAddToBasketFromProductPage:
    ...
    def setup(self, browser):
        ...
        self.login_page.register_new_user(str(time.time()) + "@fakemail.org", "12345678NIkiTA87654321")
        self.page.open()
